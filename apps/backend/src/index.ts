...
const handleVersion = (_req: Request, res: Response) => {
  res.json({
    ...
    version: '4.5.4-candidate',
    commit: '7a598175ddc622ea7cad24dfb374e88ba64d7b7f',
    candidateSha: '7a598175ddc622ea7cad24dfb374e88ba64d7b7f',
    runningSha: '7a598175ddc622ea7cad24dfb374e88ba64d7b7f',
    shortCommit: '7a59817',
    shortSha: '7a59817',
    status: 'IMPLEMENTED_AWAITING_HOMOLOGATION',
    package: 'HOTFIX 4.5.4 — Toolbox Compacta Completa em Lista + Fluxo Vertical Natural',
