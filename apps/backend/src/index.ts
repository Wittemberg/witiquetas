...
const handleVersion = (_req: Request, res: Response) => {
  res.json({
    ...
    version: '4.5.6.1-hotfix',
    commit: 'bdc5b09faa31b5ea14be7cc75c59773d04010e40',
    candidateSha: 'bdc5b09faa31b5ea14be7cc75c59773d04010e40',
    runningSha: 'bdc5b09faa31b5ea14be7cc75c59773d04010e40',
    shortCommit: 'bdc5b09',
    shortSha: 'bdc5b09',
    governanceSha: 'ec6434f9402ca98a9a81410b9c5fcaac7097d019',
    status: 'HOMOLOGATED_FROZEN',
    package: 'HOTFIX 4.5.6.1 — Restaurar DCC + Preview da Central',
