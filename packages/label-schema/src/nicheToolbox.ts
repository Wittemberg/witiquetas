...
export const NICHE_TOOLBOX_CONFIGS: Record<string, NicheToolboxConfig> = {
  'gondola-supermercado': {
    ...
    recommendedTools: [
      ...
      { toolId: 'promotional-price', label: 'Preço Promo', iconName: 'Tag', elementType: 'price', bindingPreset: { source: 'integration', fieldId: 'produto.precoPromocional', namespace: 'produto' }, defaultProperties: { isPromotional: true }, inspectorProfile: 'promotional-price', order: 3 },
  ...
  'produto-codigo-barras': {
    ...
    availableTools: [
      ...
      { toolId: 'promotional-price', label: 'Preço Promo', iconName: 'Tag', elementType: 'price', bindingPreset: { source: 'integration', fieldId: 'produto.precoPromocional', namespace: 'produto' }, order: 13 },
    ],
  ...
  'joalheria-otica': {
    ...
    availableTools: [
      TOOL_FREE_TEXT,
      { toolId: 'promotional-price', label: 'Preço Promo', iconName: 'Tag', elementType: 'price', bindingPreset: { source: 'integration', fieldId: 'produto.precoPromocional', namespace: 'produto' }, order: 10 },
  ...
  'confeccao-vestuario': {
    ...
    availableTools: [
      ...
      { toolId: 'promotional-price', label: 'Preço Promo', iconName: 'Tag', elementType: 'price', bindingPreset: { source: 'integration', fieldId: 'produto.precoPromocional', namespace: 'produto' }, order: 12 },
    ],
