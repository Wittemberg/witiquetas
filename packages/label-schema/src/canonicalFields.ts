...
// ==========================================
// PRESETS DE INTEGRAÇÃO CANÔNICOS (FASE 5 / PACOTE 5.6)
// ==========================================
import type { IntegrationPresetDTO } from '@witiquetas/contracts';

export const INTEGRATION_PRESETS: IntegrationPresetDTO[] = [
  {
    presetId: 'startwo-retail-v1',
    name: 'Startwo Varejo',
    description: 'Conector de dados comerciais e produtos para o ERP Startwo Varejo',
    providerType: 'REST',
    ...
    manifest: {
      ...
      description: 'Conector oficial Startwo para produtos, preços e estoque de gôndola',
      capabilities: ['products.read', 'prices.read', 'inventory.read'],
      fields: [
        { externalField: 'CODIGO', label: 'Código do Item', type: 'integer', suggestedCanonical: 'produto.sku' },
        { externalField: 'MERCADORIA', label: 'Descrição da Mercadoria', type: 'string', suggestedCanonical: 'produto.descricao' },
        { externalField: 'CODBARRAS', label: 'Código de Barras EAN-13', type: 'barcode', suggestedCanonical: 'produto.ean' },
        { externalField: 'PRECO_VENDA', label: 'Preço de Venda', type: 'decimal', suggestedCanonical: 'produto.preco' },
        { externalField: 'PRECO_PROMOCIONAL', label: 'Preço Promocional', type: 'decimal', suggestedCanonical: 'produto.precoPromocional' },
        { externalField: 'UNIDADE', label: 'Unidade Comercial', type: 'string', suggestedCanonical: 'produto.unidade' },
        { externalField: 'FABRICANTE', label: 'Marca / Fabricante', type: 'string', suggestedCanonical: 'produto.marca' },
      ],
    },
    defaultMappings: [
      { externalField: 'CODIGO', canonicalFieldId: 'produto.sku' },
      { externalField: 'MERCADORIA', canonicalFieldId: 'produto.descricao' },
      { externalField: 'CODBARRAS', canonicalFieldId: 'produto.ean' },
      { externalField: 'PRECO_VENDA', canonicalFieldId: 'produto.preco' },
      { externalField: 'PRECO_PROMOCIONAL', canonicalFieldId: 'produto.precoPromocional' },
      { externalField: 'UNIDADE', canonicalFieldId: 'produto.unidade' },
      { externalField: 'FABRICANTE', canonicalFieldId: 'produto.marca' },
    ],
  },
  {
    presetId: 'totvs-protheus-v1',
    name: 'TOTVS Protheus',
    description: 'Conector padrão para tabelas SB1 e SB2 do TOTVS Protheus',
    providerType: 'SQL',
    defaultNicheId: 'niche-gondola',
    manifest: {
      manifestVersion: '1',
      providerId: 'totvs-protheus-v1',
      displayName: 'TOTVS Protheus ERP',
      description: 'Integração com tabelas de produtos, preços e estoque',
      capabilities: ['products.read', 'prices.read', 'inventory.read'],
      fields: [
        { externalField: 'B1_COD', label: 'Código do Produto (SB1)', type: 'string', suggestedCanonical: 'produto.sku' },
        { externalField: 'B1_DESC', label: 'Descrição do Produto (SB1)', type: 'string', suggestedCanonical: 'produto.descricao' },
        { externalField: 'B1_CODBAR', label: 'Código de Barras (SB1)', type: 'barcode', suggestedCanonical: 'produto.ean' },
        { externalField: 'B1_PRV1', label: 'Preço de Tabela (SB1)', type: 'decimal', suggestedCanonical: 'produto.preco' },
        { externalField: 'B1_UM', label: 'Unidade de Medida (SB1)', type: 'string', suggestedCanonical: 'produto.unidade' },
      ],
    },
    defaultMappings: [
      { externalField: 'B1_COD', canonicalFieldId: 'produto.sku' },
      { externalField: 'B1_DESC', canonicalFieldId: 'produto.descricao' },
      { externalField: 'B1_CODBAR', canonicalFieldId: 'produto.ean' },
      { externalField: 'B1_PRV1', canonicalFieldId: 'produto.preco' },
      { externalField: 'B1_UM', canonicalFieldId: 'produto.unidade' },
    ],
  },
  {
    presetId: 'csv-generic-v1',
    name: 'Planilha CSV / Tabular',
    description: 'Carga declarativa a partir de arquivos CSV ou planilhas',
    providerType: 'CSV',
    defaultNicheId: 'niche-gondola',
    manifest: {
      manifestVersion: '1',
      providerId: 'csv-generic-v1',
      displayName: 'Arquivo Tabular CSV',
      description: 'Importação declarativa de colunas CSV',
      capabilities: ['products.read', 'prices.read', 'logistics.read'],
      fields: [
        { externalField: 'codigo', label: 'Código', type: 'string', suggestedCanonical: 'produto.sku' },
        { externalField: 'descricao', label: 'Descrição', type: 'string', suggestedCanonical: 'produto.descricao' },
        { externalField: 'codigo_barras', label: 'Código de Barras', type: 'barcode', suggestedCanonical: 'produto.ean' },
        { externalField: 'preco', label: 'Preço', type: 'decimal', suggestedCanonical: 'produto.preco' },
      ],
    },
    defaultMappings: [
      { externalField: 'codigo', canonicalFieldId: 'produto.sku' },
      { externalField: 'descricao', canonicalFieldId: 'produto.descricao' },
      { externalField: 'codigo_barras', canonicalFieldId: 'produto.ean' },
      { externalField: 'preco', canonicalFieldId: 'produto.preco' },
    ],
  },
  {
    presetId: 'custom-rest-v1',
    name: 'API REST Externa',
    description: 'Conexão declarativa com serviços web REST',
    providerType: 'REST',
    defaultNicheId: 'niche-gondola',
    manifest: {
      manifestVersion: '1',
      ...
      description: 'Endpoint REST para catálogo e consulta',
      capabilities: ['products.read', 'prices.read', 'customers.read'],
      fields: [
        { externalField: 'sku', label: 'SKU / ID', type: 'string', suggestedCanonical: 'produto.sku' },
        { externalField: 'name', label: 'Nome do Item', type: 'string', suggestedCanonical: 'produto.descricao' },
        { externalField: 'barcode', label: 'Barcode', type: 'barcode', suggestedCanonical: 'produto.ean' },
        { externalField: 'price', label: 'Preço', type: 'decimal', suggestedCanonical: 'produto.preco' },
      ],
    },
    defaultMappings: [
      { externalField: 'sku', canonicalFieldId: 'produto.sku' },
      { externalField: 'name', canonicalFieldId: 'produto.descricao' },
      { externalField: 'barcode', canonicalFieldId: 'produto.ean' },
      { externalField: 'price', canonicalFieldId: 'produto.preco' },
    ],
  },
];
